function CLevelMenu(){
	...
	_pStartPosExit = {x:CANVAS_WIDTH - (oSprite.width/2)-6,y:(oSprite.height/2)+6};
        ...
        if(DISABLE_SOUND_MOBILE === false || s_bMobile === false){
            _pStartPosAudio = {x:_oButExit.getX() - oSprite.width,y:(oSprite.height/2)+6 }
        ...
        if (_fRequestFullScreen && screenfull.isEnabled){
            ...
            _pStartPosFullscreen = {x: oSprite.width/4 + 6,y:(oSprite.height/2)+6};
