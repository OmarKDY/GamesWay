<?php
    /*
    Plugin Name: CTL Arcade - Funny Faces
    Plugin URI: http://www.codethislab.com/
    Description: Funny Faces for CTL Arcade Wordpress Plugin.
    Version: 1.0
    ...
    */
    ...
    class CTLArcadeFunnyFaces{

        // variabili membro
        private $_szCompatibleArcadeVersion = "1";
        private $_szPluginDir               = "ctl-funny-faces";
        private $_szPluginName              = "Funny Faces";
        private $_szAspectRatio             = "9:16";
        private $_bGameRankAvailable        = 1; // 1 yes, 0 no
        private $_szGameTags                = "bejeweled, candy crush, canvas, color match, html 5, html5 matching, match 3, match-3, matching, matching game, puzzle game, Seven Senses";
    ...
    $g_oCTLArcadeFunnyFaces =  new CTLArcadeFunnyFaces();
