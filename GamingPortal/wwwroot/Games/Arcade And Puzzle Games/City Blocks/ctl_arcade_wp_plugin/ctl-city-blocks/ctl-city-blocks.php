<?php
    /*
    Plugin Name: CTL Arcade - City Blocks
    Plugin URI: http://www.codethislab.com/
    Description: City Blocks for CTL Arcade Wordpress Plugin.
    Version: 1.0
    ...
    */
    ...
    class CTLArcadeCityBlocks {

        // variabili membro
        private $_szCompatibleArcadeVersion = "1";
        private $_szPluginDir               = "ctl-city-blocks";
        private $_szPluginName              = "City Blocks";
        private $_szAspectRatio             = "11:15";
        private $_bGameRankAvailable        = 1; // 1 yes, 0 no
        private $_szGameTags                = "arcade game, block, build, classic game, gravity, html5 arcade game, html5 pixel art, physics, pixel art, retro game, stack, tower";
    ...
    $g_oCTLArcadeCityBlocks =  new CTLArcadeCityBlocks();
