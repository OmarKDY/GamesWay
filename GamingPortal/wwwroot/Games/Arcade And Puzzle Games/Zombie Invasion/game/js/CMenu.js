function CMenu(){
    ...
    this._init = function(){
        ...
        _pStartPosPlay = {x:(CANVAS_WIDTH/2),y:CANVAS_HEIGHT -75};
        var oSprite = s_oSpriteLibrary.getSprite('but_play');
        _oButPlay = new CTextButton(_pStartPosPlay.x,_pStartPosPlay.y,oSprite,TEXT_PLAY,PRIMARY_FONT,"#ffffff",50,s_oStage);
    ...
    this.refreshButtonPos = function(iNewX,iNewY){
        ...
        _oButPlay.setPosition(_pStartPosPlay.x,-iNewY + _pStartPosPlay.y);
