<?php
    /*
    Plugin Name: CTL Arcade - Radioactive Ball
    Plugin URI: http://www.codethislab.com/
    Description: Radioactive Ball for CTL Arcade Wordpress Plugin.
    Version: 1.0
    ...
    */
    ...
    class CTLArcadeRadioactiveBall {

        // variabili membro
        private $_szCompatibleArcadeVersion = "1";
        private $_szPluginDir               = "ctl-radioactive-ball";
        private $_szPluginName              = "Radioactive Ball";
        private $_szAspectRatio             = "16:9";
        private $_bGameRankAvailable        = 1; // 1 yes, 0 no
        private $_szGameTags                = "arcade game, pixel game, pang, Pomping World, Buster Bros, action game, super pang, wordpress game, bubble buster, action game, android, ios, classic game, pixel art, retro game";
    ...
    $g_oCTLArcadeRadioactiveBall =  new CTLArcadeRadioactiveBall();
