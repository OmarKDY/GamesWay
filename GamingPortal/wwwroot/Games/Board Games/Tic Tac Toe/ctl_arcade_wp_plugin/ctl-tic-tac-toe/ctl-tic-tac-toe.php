<?php
    /*
    Plugin Name: CTL Arcade - Tic Tac Toe
    Plugin URI: http://www.codethislab.com/
    Description: Tic Tac Toe for CTL Arcade Wordpress Plugin.
    Version: 1.0
    ...
    */
    ...
    class CTLArcadeTicTacToe{

        // variabili membro
        private $_szCompatibleArcadeVersion = "1";
        private $_szPluginDir               = "ctl-tic-tac-toe";
        private $_szPluginName              = "Tic Tac Toe";
        private $_szAspectRatio             = "4:5";
        private $_bGameRankAvailable        = 0; // 1 yes, 0 no
        private $_szGameTags                = "match, puzzle, strategy, tic tac toe, tris, board game, arcade, arcade game,matching, html5 tic tac toe";
    ...
    $g_oCTLArcadeTicTacToe =  new CTLArcadeTicTacToe();
