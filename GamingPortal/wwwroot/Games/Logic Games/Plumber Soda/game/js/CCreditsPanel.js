function CCreditsPanel() {
    ...
    this._init = function () {
        ...
        _oMsgText = new createjs.Text(TEXT_CREDITS_DEVELOPED, "50px " + PRIMARY_FONT, PRIMARY_FONT_COLOR);
	...
	_oContainer.addChild(_oMsgText);
        ...
        _oLink = new createjs.Text(TEXT_LINK, "36px " + PRIMARY_FONT, PRIMARY_FONT_COLOR);
