function CToggle(iXPos,iYPos,oSprite,bActive){
    ...
    this.unload = function(){
       _oButton.off("mousedown", _mousedown);
       _oButton.off("pressup" , _mouseup);
	   
       s_oStage.removeChild(_oButton);
    };
    
    this._initListener = function(){
       _mousedown = _oButton.on("mousedown", this.buttonDown);
       _mouseup = _oButton.on("pressup" , this.buttonRelease);      
    };
