<?php
    /*
    Plugin Name: CTL Arcade - Free Words
    Plugin URI: http://www.codethislab.com/
    Description: Free Words for CTL Arcade Wordpress Plugin.
    Version: 1.0
    ...
    */
    ...
    class CTLArcadeFreeWords {

        // variabili membro
        private $_szCompatibleArcadeVersion = "1";
        private $_szPluginDir               = "ctl-free-words";
        private $_szPluginName              = "Free Words";
        private $_szAspectRatio             = "20:9";
        private $_bGameRankAvailable        = 1; // 1 yes, 0 no
        private $_szGameTags                = "html5 word game, html5 puzzle, puzzle game, word game, kids game, ruzzle,  word game, anagrams, brain game, word html5 game, html5 solitaire, solitaire game, table game, strategy game, classic game";
    ...
    $g_oCTLArcadeFreeWords =  new CTLArcadeFreeWords();
