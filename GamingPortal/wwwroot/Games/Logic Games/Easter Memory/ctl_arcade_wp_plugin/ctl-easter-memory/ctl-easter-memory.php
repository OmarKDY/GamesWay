<?php
    /*
    Plugin Name: CTL Arcade - Easter Memory
    Plugin URI: http://www.codethislab.com/
    Description: Easter Memory for CTL Arcade Wordpress Plugin.
    Version: 1.0
    ...
    */
    ...
    class CTLArcadeEasterMemory{

        // variabili membro
        private $_szCompatibleArcadeVersion = "1";
        private $_szPluginDir               = "ctl-easter-memory";
        private $_szPluginName              = "Easter Memory";
        private $_szAspectRatio             = "16:9";
        private $_bGameRankAvailable        = 1; // 1 yes, 0 no
        private $_szGameTags                = "brain game, card, cards, easter, game, html5, memory, memory game, puzzle, seasonal, skill, strategy, kid game, children game, skill game";
    ...
    $g_oCTLArcadeEasterMemory =  new CTLArcadeEasterMemory();
