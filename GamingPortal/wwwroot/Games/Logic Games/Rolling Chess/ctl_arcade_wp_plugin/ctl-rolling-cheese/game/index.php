    ...
    <body ondragstart="return false;" ondrop="return false;" >
        ...
        <script>
            $(document).ready(function () {
                var oMain = new CMain({
                        level_points: 100,              // HOW MANY POINTS A COMPLETED LEVEL IS VALUED
                        all_levels_unlocked: false,     // SET THIS TO TRUE IF YOU WANT TO UNLOCK THE FULL GAME            
