function CMain(oData){
    ...
    this._initSounds = function(){
        ...
        aSoundsInfo.push({path: './sounds/',filename:'combo_plus',loop:false,volume:1, ingamename: 'combo_plus'});
        aSoundsInfo.push({path: './sounds/',filename:'position',loop:false,volume:1, ingamename: 'position'});
