function CCreditsPanel(){
    ...
    this._init = function(){
        ...
        var oTitle = new createjs.Text(TEXT_DEVELOPED," 40px "+FONT, "#ffffff");
        oTitle.x = oSpriteBg.width/2;
        oTitle.y = oSpriteBg.height/2-50;
        ...
        _oLogo.y = oTitle.y + 50;
        _oLogo.regX = oSprite.width/2;
        _oLogo.regY = oSprite.height/2;
        _oPanelContainer.addChild(_oLogo);
        
        
        var oLink = new createjs.Text("www.codethislab.com"," 30px "+FONT, "#ffffff");
        ...
        _oButExit = new CGfxButton(524, 110, oSprite, _oPanelContainer);
