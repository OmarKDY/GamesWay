<?php
    /*
    Plugin Name: CTL Arcade - Gummy Blocks
    Plugin URI: http://www.codethislab.com/
    Description: Gummy Blocks for CTL Arcade Wordpress Plugin.
    Version: 1.0
    ...
    */
    ...
    class CTLArcadeGummyBlocks {

        // variabili membro
        private $_szCompatibleArcadeVersion = "1";
        private $_szPluginDir               = "ctl-gummy-blocks";
        private $_szPluginName              = "Gummy Blocks";
        private $_szAspectRatio             = "4:6";
        private $_bGameRankAvailable        = 1; // 1 yes, 0 no
        private $_szGameTags                = "1010 game, android game, block, blocks, html matching, iOS GAME, match 3, matching, matching game, mind game, puzzle game, strategy, strategy game, tetris";
    ...
    $g_oCTLArcadeGummyBlocks =  new CTLArcadeGummyBlocks();
