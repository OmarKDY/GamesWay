<?php
    /*
    Plugin Name: CTL Arcade - Wordoku
    Plugin URI: http://www.codethislab.com/
    Description: Wordoku for CTL Arcade Wordpress Plugin.
    Version: 1.0
    ...
    */
    ...
    class CTLArcadeWordoku {

        // variabili membro
        private $_szCompatibleArcadeVersion = "1";
        private $_szPluginDir               = "ctl-wordoku";
        private $_szPluginName              = "Wordoku";
        private $_szAspectRatio             = "9:16";
        private $_bGameRankAvailable        = 1; // 1 yes, 0 no
        private $_szGameTags                = "board game, brain game, brain teasers, crossword, grid, word game, html5 sudoku, math game, letter, skill game, sudoku";
    ...
    $g_oCTLArcadeWordoku =  new CTLArcadeWordoku();