<?php
    /*
    Plugin Name: CTL Arcade - Classic Nonogram
    Plugin URI: http://www.codethislab.com/
    Description: Classic Nonogram for CTL Arcade Wordpress Plugin.
    Version: 1.0
    ...
    */
    ...
    class CTLArcadeClassicNonogram {

        // variabili membro
        private $_szCompatibleArcadeVersion = "1";
        private $_szPluginDir               = "ctl-classic-nonogram";
        private $_szPluginName              = "Classic Nonogram";
        private $_szAspectRatio             = "16:9";
        private $_bGameRankAvailable        = 1; // 1 yes, 0 no
        private $_szGameTags                = "board game, brain game, brain teasers, crossword, grid, html5 board game, coloring game, math game, numbers, skill game, sudoku";
    ...
    $g_oCTLArcadeClassicNonogram =  new CTLArcadeClassicNonogram();
