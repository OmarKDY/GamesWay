function CAreYouSurePanel(oParentContainer) {
    ...
    this._init = function () {
        ...
        _oButYes = new CGfxButton(oSpriteBg.width-200, 550, s_oSpriteLibrary.getSprite('but_yes'), _oPanelContainer);
        _oButYes.addEventListener(ON_MOUSE_UP, this._onButYes, this);

        _oButNo = new CGfxButton(200, 550, s_oSpriteLibrary.getSprite('but_no'), _oPanelContainer);
    ...
    this.show = function (szText) {
        ...
        _oPanelContainer.scaleX = _oPanelContainer.scaleY = 0.0;
        _oContainer.visible = true;
        createjs.Tween.get(_oPanelContainer).wait(500).to({scaleX: 1,scaleY:1}, 1500, createjs.Ease.elasticOut);
    };
