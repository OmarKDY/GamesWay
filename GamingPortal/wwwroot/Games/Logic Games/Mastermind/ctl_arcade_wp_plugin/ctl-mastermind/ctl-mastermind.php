<?php
    /*
    Plugin Name: CTL Arcade - Mastermind
    Plugin URI: http://www.codethislab.com/
    Description: Mastermind for CTL Arcade Wordpress Plugin.
    Version: 1.0
    ...
    */
    ...
    class CTLArcadeMastermind{

        // variabili membro
        private $_szCompatibleArcadeVersion = "1";
        private $_szPluginDir               = "ctl-mastermind";
        private $_szPluginName              = "Mastermind";
        private $_szAspectRatio             = "6:11";
        private $_bGameRankAvailable        = 1; // 1 yes, 0 no
        private $_szGameTags                = "brain game, skill game, matching game, logic game, mastermind, guessing game, strategy, classic game, brain teaser, quiz game, board game, code-breaking game, code breaking game, deduction game, logics";
    ...
    $g_oCTLArcadeMastermind =  new CTLArcadeMastermind();
