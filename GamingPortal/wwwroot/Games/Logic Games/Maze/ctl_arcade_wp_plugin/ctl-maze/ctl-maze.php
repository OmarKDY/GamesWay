<?php
    /*
    Plugin Name: CTL Arcade - Maze
    Plugin URI: http://www.codethislab.com/
    Description: Maze for CTL Arcade Wordpress Plugin.
    Version: 1.0
    ...
    */
    ...
    class CTLArcadeMaze{
        ...
        private $_szPluginDir               = "ctl-maze";
        private $_szPluginName              = "Maze";
        private $_szAspectRatio             = "5:9";
        private $_bGameRankAvailable        = 1; // 1 yes, 0 no
        private $_szGameTags                = "maze, labyrinth, brain game, skill game, logic game, strategy, classic game, brain teaser, quiz game, board game, deduction game, logics, puzzle, skill, html5";
    ...
    $g_oCTLArcadeMaze =  new CTLArcadeMaze();
