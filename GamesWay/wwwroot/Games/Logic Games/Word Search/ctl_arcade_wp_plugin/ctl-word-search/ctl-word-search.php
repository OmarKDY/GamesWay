<?php
    /*
    Plugin Name: CTL Arcade - Word Search
    Plugin URI: http://www.codethislab.com/
    Description: Word Search for CTL Arcade Wordpress Plugin.
    Version: 1.0
    ...
    */
    ...
    class CTLArcadeWordSearch{

        // variabili membro
        private $_szCompatibleArcadeVersion = "1";
        private $_szPluginDir               = "ctl-word-search";
        private $_szPluginName              = "Word Search";
        private $_szAspectRatio             = "4:6";
        private $_bGameRankAvailable        = 1; // 1 yes, 0 no
        private $_szGameTags                = "word search game, wordsearch, alphabet, puzzle, guess the word game, crossword puzzle, brain teasers, puzzles, word game, find the word, multilanguage, brain game, skill game, scramble game, anagram ";
    ...
    $g_oCTLArcadeWordSearch =  new CTLArcadeWordSearch();
