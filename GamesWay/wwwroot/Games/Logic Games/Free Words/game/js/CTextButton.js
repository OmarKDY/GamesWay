function CTextButton(iXPos,iYPos,oSprite,szText,szFont,szColor,iFontSize,szAlign,iPaddingX,oParentContainer){
	...
	if (!s_bMobile){
        ...
        _oText = new CTLText(_oButton, 
                    5, 2, oSprite.width-10, oSprite.height-4, 
    ...
    this.scale = function(iNewScale){
        createjs.Tween.get(_oButton).to({scaleX:_iCurScale*iNewScale,scaleY:_iCurScale*iNewScale}, 200,createjs.Ease.cubicOut).to({scaleX:_iCurScale,scaleY:_iCurScale}, 1000,createjs.Ease.elasticOut);
    };
