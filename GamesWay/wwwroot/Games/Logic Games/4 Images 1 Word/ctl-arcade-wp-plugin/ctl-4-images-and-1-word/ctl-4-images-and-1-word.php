<?php
    /*
    Plugin Name: CTL Arcade - 4 Images And 1 Word
    Plugin URI: http://www.codethislab.com/
    Description: 4 Images And 1 Word for CTL Arcade Wordpress Plugin.
    Version: 1.0
    ...
    */
    ...
    class CTLArcade4ImagesAnd1Word {

        // variabili membro
        private $_szCompatibleArcadeVersion = "1";
        private $_szPluginDir               = "ctl-4-images-and-1-word";
        private $_szPluginName              = "4 Images and 1 Word";
        private $_szAspectRatio             = "4:6";
        private $_bGameRankAvailable        = 1; // 1 yes, 0 no
        private $_szGameTags                = "4 pics 1 word, 4 pictures 1 word, brain game, four pics one, four pictures one word, guess, knowledge game, logic game, multilingual, multilingual game, pictures, quiz game, skills game, word game, words";
    ...
    $g_oCTLArcade4ImagesAnd1Word =  new CTLArcade4ImagesAnd1Word();
