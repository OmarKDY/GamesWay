function CForms(i, iForm, oParentContainer){
    ...
    this._init = function(i, iForm, oParentContainer){
        var iForm;
        ...
        _oListenerMouseDown = _oContainerForm.on("mousedown", this._onFormContainerClick, this);
        _oListenerMouseUp = _oContainerForm.on("pressup", this._releaseForm, this );
        _oListenerMouseMove = _oContainerForm.on("pressmove", this._dragForm, this );
        _oContainerForm.cursor = "pointer";
    ...
    this.deleteForm = function(){
        _oContainerForm.off("mousedown", _oListenerMouseDown, this);
        _oContainerForm.off("pressmove", _oListenerMouseMove, this );
        _oContainerForm.off("pressup", _oListenerMouseUp, this );
        oParentContainer.removeChild(_oContainerForm);
    };
    
    this._init(i, iForm, oParentContainer);
