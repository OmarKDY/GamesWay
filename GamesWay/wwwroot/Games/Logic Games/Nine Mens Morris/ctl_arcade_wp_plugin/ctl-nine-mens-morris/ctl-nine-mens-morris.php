<?php
    /*
    Plugin Name: CTL Arcade - Nine Mens Morris
    Plugin URI: http://www.codethislab.com/
    Description: Nine Mens Morris for CTL Arcade Wordpress Plugin.
    Version: 1.0
    ...
    */
    ...
    class CTLArcadeNineMensMorris{

        // variabili membro
        private $_szCompatibleArcadeVersion = "1";
        private $_szPluginDir               = "ctl-nine-mens-morris";
        private $_szPluginName              = "Nine Mens Morris";
        private $_szAspectRatio             = "5:9";
        private $_bGameRankAvailable        = 1; // 1 yes, 0 no
        private $_szGameTags                = "Nine Man Morris, Mill, Mills, The Mill Game, Merels, Merrills, Merelles, Marelles, Morelles, Ninepenny Marl, checkers, chess,  multiplayer game, skill game, strategy game";
    ...
    $g_oCTLArcadeNineMensMorris =  new CTLArcadeNineMensMorris();
