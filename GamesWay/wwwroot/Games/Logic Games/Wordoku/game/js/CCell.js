function CCell(iX, iY, oLogicPos, oParentContainer){
    ...
    this.setHintNumber = function(iNum){
        ...
        _oNumber = new createjs.Text(iSymbol,"80px "+PRIMARY_FONT, "#add8fd");
        _oNumber.textAlign = "center";
        _oNumber.textBaseline = "middle";
        _oNumber.y = GAME_Y_OFFSET;
    ...
    this.setNumber = function(iNum){
        ...
        this.clearAllNote();
        var iSymbol = s_oNumberConverter.toText(iNum);
        _oNumber = new createjs.Text(iSymbol,"80px "+PRIMARY_FONT, "#000000");
        _oNumber.textAlign = "center";
        _oNumber.textBaseline = "middle";
        _oNumber.y = GAME_Y_OFFSET;
        _oCellContainer.addChild(_oNumber);
    ...
    this.setNote = function(iNum){
        ...
        if(_aNote[iNum] !== 0){
            ...
            var iSymbol = s_oNumberConverter.toText(iNum);
            _aNote[iNum] = new createjs.Text(iSymbol," 30px "+PRIMARY_FONT, "#000000");
