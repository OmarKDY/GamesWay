<?php
    /*
    Plugin Name: CTL Arcade - 2048 Cuteness Edition
    Plugin URI: http://www.codethislab.com/
    Description: 2048 Cuteness Edition for CTL Arcade Wordpress Plugin.
    Version: 1.0
    ...
    */
    ...
    class CTLArcade2048CutenessEdition{

        // variabili membro
        private $_szCompatibleArcadeVersion = "1";
        private $_szPluginDir               = "ctl-2048-cuteness-edition";
        private $_szPluginName              = "2048 Cuteness Edition";
        private $_szAspectRatio             = "5:9";
        private $_bGameRankAvailable        = 1; // 1 yes, 0 no
        private $_szGameTags                = "2048, kid game, puzzle, puzzle game, skill game, math, brain game, board game, sudoku, number, pet, math game, html5 2048, html5 puzzle game, summer game";
    ...
    $g_oCTLArcade2048CutenessEdition =  new CTLArcade2048CutenessEdition();
