<?php
    /*
    Plugin Name: CTL Arcade - Tap The Tile C2
    Plugin URI: http://www.codethislab.com/
    Description: Tap The Tile C2 for CTL Arcade Wordpress Plugin.
    Version: 1.0
    ...
    */
    ...
    class CTLArcadeTapTheTileC2 {

        // variabili membro
        private $_szCompatibleArcadeVersion = "1";
        private $_szPluginDir               = "ctl-tap-the-tile-c2";
        private $_szPluginName              = "Tap The Tile C2";
        private $_szAspectRatio             = "9:16";
        private $_bGameRankAvailable        = 1; // 1 yes, 0 no
        private $_szGameTags                = "tap the black tile, skill game, tap game, tapping game, logic game, survival game, endless game, piano tile, don’t tap the white tile, don’t touch, don’t tap, capx, admob, construct 2, black and white";
    ...
    $g_oCTLArcadeTapTheTileC2 =  new CTLArcadeTapTheTileC2();
