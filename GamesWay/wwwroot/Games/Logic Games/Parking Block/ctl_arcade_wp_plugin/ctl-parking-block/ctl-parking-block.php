<?php
    /*
    Plugin Name: CTL Arcade - Parking Block
    Plugin URI: http://www.codethislab.com/
    Description: Parking Block for CTL Arcade Wordpress Plugin.
    Version: 1.0
    ...
    */
    ...
    class CTLArcadeParkingBlock {

        // variabili membro
        private $_szCompatibleArcadeVersion = "1";
        private $_szPluginDir               = "ctl-parking-block";
        private $_szPluginName              = "Parking Block";
        private $_szAspectRatio             = "9:16";
        private $_bGameRankAvailable        = 1; // 1 yes, 0 no
        private $_szGameTags                = "unblock me, skill game, puzzle game, car, android, ios, unlock me, brain game, sliding game, swift, unblock, wordpress game, admob, share score, leaderboard";
    ...
    $g_oCTLArcadeParkingBlock =  new CTLArcadeParkingBlock();
