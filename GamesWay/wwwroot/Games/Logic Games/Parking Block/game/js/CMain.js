function CMain(oData){
    ...
    this._initSounds = function(){
        ...
        s_aSoundsInfo.push({path: './sounds/',filename:'car_exit',loop:true,volume:1, ingamename: 'car_exit'});
    ...
    this._loadImages = function(){
        ...
        for(var i=0; i<8; i++){
            s_oSpriteLibrary.addSprite("car_"+i,"./sprites/car_"+i+".png");
        };
    ...
    this.gotoHelp = function(){
        _oHelp = new CHelpPanel(s_oSpriteLibrary.getSprite('msg_box'));
        _iState = STATE_HELP;
    };
