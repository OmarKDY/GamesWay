function CPhysicsController(){
    ...
    this.createAContactListener = function () {        
        ...
        listener.BeginContact = function (contact) { 
            ...
            if (oUserDataA.fixture === BALL_FIXTURE || oUserDataB.fixture === BALL_FIXTURE) {
                s_oGame.onBallBounce();                
            }
            if (oUserDataA.fixture === STONE_FIXTURE || oUserDataB.fixture === STONE_FIXTURE) {
                s_oGame.onBarrellRoll();                
            }
            
            // CHECK IF A COIN HAS BEEN TAKEN
            if (oUserDataA.fixture === COIN_FIXTURE && oUserDataB.fixture === BALL_FIXTURE) {
                s_oGame.findCoinTaken(oUserDataA.id);
            }
            if (oUserDataB.fixture === COIN_FIXTURE && oUserDataA.fixture === BALL_FIXTURE) {
                s_oGame.findCoinTaken(oUserDataB.id);            
            }
            
            // CHECK IF THE BALL HAS ARRIVED TO THE PLAYER
            if (oUserDataA.fixture === PLAYER_FIXTURE && oUserDataB.fixture === BALL_FIXTURE || 
                oUserDataB.fixture === PLAYER_FIXTURE && oUserDataA.fixture === BALL_FIXTURE) {
                s_oGame.getBallToPlayer();
            }
