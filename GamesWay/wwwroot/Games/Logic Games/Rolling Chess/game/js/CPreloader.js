function CPreloader() {
    ...
    this.attachSprites = function () {
        ...
        _oIcon.y = CANVAS_HEIGHT_HALF - 80;
        ...
        _oProgressBar.y = CANVAS_HEIGHT_HALF + 150;
        ...
        _oLoadingText.y = CANVAS_HEIGHT_HALF + 200;
        _oLoadingText.textBaseline = "alphabetic";
        _oLoadingText.textAlign = "center";
        _oContainer.addChild(_oLoadingText);
        
        var oSprite = s_oSpriteLibrary.getSprite('but_start');
        _oButStart = new CTextButton(CANVAS_WIDTH_HALF, CANVAS_HEIGHT_HALF + 100, oSprite, TEXT_PRELOADER_CONTINUE, "Arial", "#000", "bold "+ 50, _oContainer);        
