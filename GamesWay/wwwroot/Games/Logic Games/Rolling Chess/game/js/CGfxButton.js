function CGfxButton(iXPos, iYPos, oSprite, oParentContainer) {
    ...
    this.buttonDown = function () {
        ...
        if (_fScaleX > 0) {
            _oButton.scaleX = 0.9*_fScaleX;
        } else {
            _oButton.scaleX = -0.9*_fScaleX;
        }
        _oButton.scaleY = 0.9*_fScaleY;
    ...
    this.pulseAnimation = function () {
        _oTween = createjs.Tween.get(_oButton,{loop:-1}).to({scaleX: _fScaleX * 0.9, scaleY: _fScaleY * 0.9}, 850, createjs.Ease.quadOut)
