<?php
    /*
    Plugin Name: CTL Arcade - Rolling Cheese
    Plugin URI: http://www.codethislab.com/
    Description: Rolling Cheese for CTL Arcade Wordpress Plugin.
    Version: 1.0
    ...
    */
    ...
    class CTLArcadeRollingCheese{

        // variabili membro
        private $_szCompatibleArcadeVersion = "1";
        private $_szPluginDir               = "ctl-rolling-cheese";
        private $_szPluginName              = "Rolling Cheese";
        private $_szAspectRatio             = "17:8";
        private $_bGameRankAvailable        = 1; // 1 yes, 0 no
        private $_szGameTags                = "children games, cartoon mouse, gravity game, html5 game, kid game, mind game, skill game, pet, physic game, physics, puzzle game, animals, cute animals, cute, girls game";
    ...
    $g_oCTLArcadeRollingCheese =  new CTLArcadeRollingCheese();
