<?php
    /*
    Plugin Name: CTL Arcade - Memory Art
    Plugin URI: http://www.codethislab.com/
    Description: Memory Art for CTL Arcade Wordpress Plugin.
    Version: 1.0
    ...
    */
    ...
    class CTLArcadeMemoryArt{

        // variabili membro
        private $_szCompatibleArcadeVersion = "1";
        private $_szPluginDir               = "ctl-memory-art";
        private $_szPluginName              = "Memory Art";
        private $_szAspectRatio             = "9:16";
        private $_bGameRankAvailable        = 1; // 1 yes, 0 no
        private $_szGameTags                = "memory, mobile, puzzle, puzzle game, simon, memory game, mind game, quiz game, simon game, speed game, educational game, kid game, music game";
    ...
    $g_oCTLArcadeMemoryArt =  new CTLArcadeMemoryArt();
