function CCreditsPanel(){
    ...
    this._init = function(){
        ...
        _oMsgText = new CTLText(_oContainer, 
                    CANVAS_WIDTH/2 -iWidth/2, 334 - iHeight/2, iWidth, iHeight, 
                    36, "center", "#ffffff", "Arial", 1,
                    2, 2,
        ...
        _oLink = new CTLText(_oContainer, 
                    CANVAS_WIDTH/2 -iWidth/2, 448 - iHeight/2, iWidth, iHeight, 
                    34, "center", "#ffffff", "Arial", 1,
                    2, 2,
                    "www.codethislab.com",
                    true, true, true,
                    false );
        ...
        _pStartPosExit = {x: CANVAS_WIDTH/2 +210, y: 274};
