<?php
    /*
    Plugin Name: CTL Arcade - Plumber Soda
    Plugin URI: http://www.codethislab.com/
    Description: Plumber Soda for CTL Arcade Wordpress Plugin.
    Version: 1.0
    ...
    */
    ...
    class CTLArcadePlumberSoda {

        // variabili membro
        private $_szCompatibleArcadeVersion = "1";
        private $_szPluginDir               = "ctl-plumber-soda";
        private $_szPluginName              = "Plumber Soda";
        private $_szAspectRatio             = "16:9";
        private $_bGameRankAvailable        = 1; // 1 yes, 0 no
        private $_szGameTags                = "addictive, arcade, board, children game, classic, html5 pipe, pipe dream, pipe game, pipe mania, plumber, puzzle game, retro, skill game, soda, tube";
    ...
    $g_oCTLArcadePlumberSoda =  new CTLArcadePlumberSoda();
