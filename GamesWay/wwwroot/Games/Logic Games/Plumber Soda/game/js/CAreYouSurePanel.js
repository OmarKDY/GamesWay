function CAreYouSurePanel() {
    ...
    this._init = function () {
        ...
        var oTitle = new CTLText(_oPanelContainer, 
                    ...
                    80, "center", PRIMARY_FONT_COLOR, PRIMARY_FONT, 1,
                    0, 0,
                    TEXT_ARE_SURE,
                    true, true, true,
                    false );
        ...
        _oButYes = new CGfxButton(CANVAS_WIDTH_HALF + iButtonsOffsetX, iButtonsY, s_oSpriteLibrary.getSprite('but_yes'), _oPanelContainer);
