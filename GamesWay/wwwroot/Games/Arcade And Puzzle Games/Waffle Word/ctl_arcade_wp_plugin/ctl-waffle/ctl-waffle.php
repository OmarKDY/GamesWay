<?php
    /*
    Plugin Name: CTL Arcade - Waffle
    Plugin URI: http://www.codethislab.com/
    Description: Waffle for CTL Arcade Wordpress Plugin.
    Version: 1.1
    ...
    */
    ...
    class CTLArcadeWaffle{

        // variabili membro
        private $_szCompatibleArcadeVersion = "1";
        private $_szPluginDir               = "ctl-waffle";
        private $_szPluginName              = "Waffle";
        private $_szAspectRatio             = "19:9";
        private $_bGameRankAvailable        = 1; // 1 yes, 0 no
        private $_szGameTags                = "anagram, drag, game, html5, languages, letters, mobile, puzzle, ruzzle, skill, word, word game, multilanguage, kid game, school game, educational";
    ...
    $g_oCTLArcadeWaffle =  new CTLArcadeWaffle();
