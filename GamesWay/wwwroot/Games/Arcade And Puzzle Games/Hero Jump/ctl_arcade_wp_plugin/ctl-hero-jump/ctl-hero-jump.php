<?php
    /*
    Plugin Name: CTL Arcade - Hero Jump
    Plugin URI: http://www.codethislab.com/
    Description: Hero Jump for CTL Arcade Wordpress Plugin.
    Version: 1.0
    ...
    */
    ...
    class CTLArcadeHeroJump {

        // variabili membro
        private $_szCompatibleArcadeVersion = "1";
        private $_szPluginDir               = "ctl-hero-jump";
        private $_szPluginName              = "Hero Jump";
        private $_szAspectRatio             = "10:15";
        private $_bGameRankAvailable        = 1; // 1 yes, 0 no
        private $_szGameTags                = "arcade game, endless game, classic game, action game, doodle jump, jumping game, HTML5 jump game, jump game, mobile jump game, survival game, wordpress, leaderboard, facebook, twitter, share score";
    ...
    $g_oCTLArcadeHeroJump =  new CTLArcadeHeroJump();
