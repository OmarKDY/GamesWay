<?php
    /*
    Plugin Name: CTL Arcade - Galactic War
    Plugin URI: http://www.codethislab.com/
    Description: Galactic War for CTL Arcade Wordpress Plugin.
    Version: 1.0
    ...
    */
    ...
    class CTLArcadeGalacticWar{

        // variabili membro
        private $_szCompatibleArcadeVersion = "1";
        private $_szPluginDir               = "ctl-galactic-war";
        private $_szPluginName              = "Galactic War";
        private $_szAspectRatio             = "12:15";
        private $_bGameRankAvailable        = 1; // 1 yes, 0 no
        private $_szGameTags                = "arcade, bullet, mobile, retro, shooter, space, spaceship, space game, arcade game, retro game, classic game, asteroids, shot, shoot, shooting game";
    ...
    $g_oCTLArcadeGalacticWar =  new CTLArcadeGalacticWar();
