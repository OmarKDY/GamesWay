<?php
    /*
    Plugin Name: CTL Arcade - Snake
    Plugin URI: http://www.codethislab.com/
    Description: Snake for CTL Arcade Wordpress Plugin.
    Version: 1.0
    ...
    */
    ...
    class CTLArcadeSnake {

        // variabili membro
        private $_szCompatibleArcadeVersion = "1";
        private $_szPluginDir               = "ctl-snake";
        private $_szPluginName              = "Snake";
        private $_szAspectRatio             = "16:9";
        private $_bGameRankAvailable        = 1; // 1 yes, 0 no
        private $_szGameTags                = "android game, Animals Game, arcade game, browser game, classic, classic game, fruit, iOS GAME, level, mobile game, nokia 3310, nokia game, puzzle, retro game, snake";
    ...
    $g_oCTLArcadeSnake =  new CTLArcadeSnake();
