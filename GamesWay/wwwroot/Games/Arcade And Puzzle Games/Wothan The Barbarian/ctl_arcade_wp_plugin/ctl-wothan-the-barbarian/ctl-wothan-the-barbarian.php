<?php
    /*
    Plugin Name: CTL Arcade - Wothan The Barbarian
    Plugin URI: http://www.codethislab.com/
    Description: Wothan The Barbarian for CTL Arcade Wordpress Plugin.
    Version: 1.0
    ...
    */
    ...
    class CTLArcadeWothanTheBarbarian {

        // variabili membro
        private $_szCompatibleArcadeVersion = "1";
        private $_szPluginDir               = "ctl-wothan-the-barbarian";
        private $_szPluginName              = "Wothan The Barbarian";
        private $_szAspectRatio             = "4:6";
        private $_bGameRankAvailable        = 1; // 1 yes, 0 no
        private $_szGameTags                = "Rapid roll, fall game, falling game, rolling game, jumping game, roll jump, classic game, action game, survival game,  escaping game, wordpress, facebook, twitter, doodle jump, mega jump, running game";
    ...
    $g_oCTLArcadeWothanTheBarbarian =  new CTLArcadeWothanTheBarbarian();
