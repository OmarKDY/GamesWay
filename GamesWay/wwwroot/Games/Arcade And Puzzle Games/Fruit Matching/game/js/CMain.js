function CMain(oData){
    ...
    this._initSounds = function(){
        ...
        s_aSoundsInfo.push({path: './sounds/',filename:'fn_explosion',loop:false,volume:1, ingamename: 'fn_explosion'});
        ...
        s_aSoundsInfo.push({path: './sounds/',filename:'break2',loop:false,volume:1, ingamename: 'break2'});
