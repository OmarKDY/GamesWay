function CInterface(iCurLevel){
    ...
    this._init = function(iCurLevel){  
        ...
        _oScoreStrokeText = new CTLText(s_oStage, 
                    41,182, 175, 25, 
                    25, "right", "#ff0000", PRIMARY_FONT, 1,
                    0, 0,
                    "000000000",
                    true, true, false,
                    false);
        
        _oScoreStrokeText.setOutline(4);
    ...
    this.refreshScore = function(iValue){
        ...
        _oScoreStrokeText.refreshText(iNumber);
        _oScoreText.refreshText(iNumber);
    ...
    this._onButRestartRelease = function(){
        if(!s_oGame.getBlock()){
            _oConfirmRestartPanel.show(TEXT_ARE_SURE, 44);
        }
    };
    ...
    this._onExit = function(){
        if(!s_oGame.getBlock()){
            _oAreYouSurePanel.show(TEXT_ARE_SURE, 44);
        }
    };
