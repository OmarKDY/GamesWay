<?php
    /*
    Plugin Name: CTL Arcade - Fruit Matching
    Plugin URI: http://www.codethislab.com/
    Description: Fruit Matching for CTL Arcade Wordpress Plugin.
    Version: 1.0
    ...
    */
    ...
    class CTLArcadeFruitMatching {

        // variabili membro
        private $_szCompatibleArcadeVersion = "1";
        private $_szPluginDir               = "ctl-fruit-matching";
        private $_szPluginName              = "Fruit Matching";
        private $_szAspectRatio             = "9:16";
        private $_bGameRankAvailable        = 1; // 1 yes, 0 no
        private $_szGameTags                = "arcade game, bejeweled, candy, candy crush, color match, fruit, fruit game, match 3, match-3, matching, matching game, puzzle game, Seven Senses matching";
    ...
    $g_oCTLArcadeFruitMatching =  new CTLArcadeFruitMatching();
