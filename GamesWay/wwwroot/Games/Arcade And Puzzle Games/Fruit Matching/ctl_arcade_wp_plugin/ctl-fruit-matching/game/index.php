...
<html>
	...
	<div style="position: fixed; background-color: transparent; top: 0px; left: 0px; width: 100%; height: 100%"></div>
          <script>
            $(document).ready(function(){
                     var oMain = new CMain({
                                            ...
                                            scores_for_single: 30,                      //SCORE FOR SINGLE FRUIT DESTROYED
                                            scores_for_bomb: 100,                       //SCORE FOR BOMB DESTROYED
                                            extra_item_multiplier: 1.5,                 //SCORE MULTIPLIER APPLIED FOR EXTRA ITEM DESTROYED
        ...
        <canvas id="canvas" class='ani_hack' width="540" height="960"> </canvas>
