<?php
    /*
    Plugin Name: CTL Arcade - Jumper Frog
    Plugin URI: http://www.codethislab.com/
    Description: Jumper Frog for CTL Arcade Wordpress Plugin.
    Version: 1.0
    ...
    */
    ...
    class CTLArcadeJumperFrog {

        // variabili membro
        private $_szCompatibleArcadeVersion = "1";
        private $_szPluginDir               = "ctl-jumper-frog";
        private $_szPluginName              = "Jumper Frog";
        private $_szAspectRatio             = "19:20";
        private $_bGameRankAvailable        = 1; // 1 yes, 0 no
        private $_szGameTags                = "arcade, arcade game, classic game, frogger, html5 arcade game, html5 retro game, jump, retro game,skill game, kids game, funny game";
    ...
    $g_oCTLArcadeJumperFrog =  new CTLArcadeJumperFrog();