<?php
    /*
    Plugin Name: CTL Arcade - Flags Maniac C2
    Plugin URI: http://www.codethislab.com/
    Description: Flags Maniac C2 for CTL Arcade Wordpress Plugin.
    Version: 1.0
    ...
    */
    ...
    class CTLArcadeFlagsManiacC2 {

        // variabili membro
        private $_szCompatibleArcadeVersion = "1";
        private $_szPluginDir               = "ctl-flags-maniac-c2";
        private $_szPluginName              = "Flags Maniac C2";
        private $_szAspectRatio             = "2:3";
        private $_bGameRankAvailable        = 1; // 1 yes, 0 no
        private $_szGameTags                = "brain game, didactive game, educational game, flag, geo quiz, geography, kid game, knowledge, knowledge game, memory, memory game, quiz, quiz game, School game";
    ...
    $g_oCTLArcadeFlagsManiacC2 =  new CTLArcadeFlagsManiacC2();
