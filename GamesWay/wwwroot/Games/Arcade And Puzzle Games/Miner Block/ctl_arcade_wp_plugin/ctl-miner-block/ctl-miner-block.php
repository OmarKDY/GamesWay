<?php
    /*
    Plugin Name: CTL Arcade - Miner Block
    Plugin URI: http://www.codethislab.com/
    Description: Miner Block for CTL Arcade Wordpress Plugin.
    Version: 1.0
    ...
    */
    ...
    class CTLArcadeMinerBlock {

        // variabili membro
        private $_szCompatibleArcadeVersion = "1";
        private $_szPluginDir               = "ctl-miner-block";
        private $_szPluginName              = "Miner Block";
        private $_szAspectRatio             = "4:6";
        private $_bGameRankAvailable        = 1; // 1 yes, 0 no
        private $_szGameTags                = "unblock me, skill game, puzzle game, gold, android, ios, unlock me, brain game, sliding game, swift, unblock, wordpress game, admob, share score, leaderboard";
    ...
    $g_oCTLArcadeMinerBlock =  new CTLArcadeMinerBlock();
