<?php
    /*
    Plugin Name: CTL Arcade - Domino Block
    Plugin URI: http://www.codethislab.com/
    Description: Domino Block for CTL Arcade Wordpress Plugin.
    Version: 1.0
    ...
    */
    ...
    class CTLArcadeDominoBlock{

        // variabili membro
        private $_szCompatibleArcadeVersion = "1";
        private $_szPluginDir               = "ctl-domino-block";
        private $_szPluginName              = "Domino Block";
        private $_szAspectRatio             = "5:9";
        private $_bGameRankAvailable        = 1; // 1 yes, 0 no
        private $_szGameTags                = "puzzle game, classic game, logic game, skill game, board game, multiplayer game,matching game, match, wordpress, strategy, domino, blocks, block, dominoes, turn based game";
    ...
    $g_oCTLArcadeDominoBlock =  new CTLArcadeDominoBlock();
