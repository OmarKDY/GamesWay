<?php
    /*
    Plugin Name: CTL Arcade - Yacht Dice Game
    Plugin URI: http://www.codethislab.com/
    Description: Yacht Dice Game for CTL Arcade Wordpress Plugin.
    Version: 1.0
    ...
    */
    ...
    class CTLArcadeYachtDiceGame {

        // variabili membro
        private $_szCompatibleArcadeVersion = "1";
        private $_szPluginDir               = "ctl-yacht-dice-game";
        private $_szPluginName              = "Yacht Dice Game";
        private $_szAspectRatio             = "17:8";
        private $_bGameRankAvailable        = 1; // 1 yes, 0 no
        private $_szGameTags                = "board game, cheerio,craps,dices,farkle,five dice,generala,poker dice,yacht,yachty,yahtzee,yatzie,yatzy";
    ...
    $g_oCTLArcadeYachtDiceGame =  new CTLArcadeYachtDiceGame();
