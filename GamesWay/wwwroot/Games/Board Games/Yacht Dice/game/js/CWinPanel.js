function CWinPanel(iScore, aPlayersScore, oContainer, bNewHighScore) {
    var _iScore;
    ...
    this._init = function () {
        ...
        _oButRetry = new CGfxButton(CANVAS_WIDTH_HALF + iButtonsOffsetX - 10, iButtonsY, oSpriteButRetry, _oMessageBoxGroup);
        _oButRetry.addEventListener(ON_MOUSE_DOWN, this._onTryAgain, this);
        _oButRetry.pulseAnimation();
    };
